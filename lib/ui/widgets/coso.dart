...
/// [CosoCard] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class CosoCard extends StatefulWidget {
  ...
  @override
  CosoCardState createState() => CosoCardState();
}

class CosoCardState extends State<CosoCard> with SingleTickerProviderStateMixin {
